...
class TransformerLayer(GraphableMegatronModule, BaseTransformerLayer):
    ...
    def _te_cuda_graph_replay(self, *args, **kwargs):
        ...
        """
        context = None
        # Read before the branch below clears kwargs. The MoE route() calls further down
        # need it, and the graph itself was captured with this kwarg
        # (get_layer_static_inputs), so dropping it here makes TE reject the replay.
        padding_mask = kwargs.get("padding_mask", None)
